  ...
  return (
    <div className="relative overflow-hidden rounded-[40px] border border-white/10 bg-gradient-to-br from-[#071018] via-[#0f1726] to-black p-10">
      ...
      <div className="relative z-10">
        ...
        <div className="mt-10 rounded-3xl border border-white/10 bg-black/20 p-6"><p className="text-sm text-gray-400">{i.primaryFocus}</p><h3 className="mt-4 text-3xl font-black text-accent-bright">{primaryFocus}</h3><p className="mt-4 max-w-4xl text-base leading-relaxed text-gray-300">{coachingMessage}</p></div>
      </div>
    </div>
  );
}
