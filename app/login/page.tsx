...
export default async function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0C1430] px-4 py-10 text-white" style={{ paddingTop: "calc(env(safe-area-inset-top) + 2.5rem)" }}>
