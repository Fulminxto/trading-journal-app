...
## Corpus Check
- 358 files · ~372,058 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 122 nodes · 159 edges · 14 communities (9 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `da012685`
...
## Knowledge Gaps
- **41 isolated node(s):** `HubCard`, `StatCardProps`, `AccountHubLabels`, `HubCardText`, `AccountsCopy` (+36 more)
...
- **What connects `HubCard`, `StatCardProps`, `AccountHubLabels` to the rest of the system?**
